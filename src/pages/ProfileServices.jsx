  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold mb-2">ملفي وخدماتي</h1>
          <p className="text-slate-500">قم بإدارة بياناتك المهنية، خدماتك الجاهزة، ومعرض أعمالك.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Left Column: Personal Info (2/3 in RTL) */}

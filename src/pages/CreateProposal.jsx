...
const CreateProposal = () => {
  ...
  // Defaulting chat ID to 1 if not present for mock navigation
  const chatId = id || "1";
    ...
    <div className="p-8 pb-20 overflow-y-auto h-full bg-gray-50">
          ...
          <div className="p-8 space-y-10">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2 text-slate-400 border-b border-slate-50 pb-2">
                ...
                <h2 className="text-sm font-bold uppercase tracking-wider">تفاصيل العرض</h2>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-700 block">نطاق العمل والتسليمات</label>
                <textarea 
                  rows={8}
                  required
                  placeholder="اشرح بالتفصيل ما ستقوم بإنجازه، والمراحل، وما سيتسلمه العميل في النهاية..."
                  className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#01696F]/10 focus:border-[#01696F] transition-all text-sm leading-relaxed resize-none"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-center gap-2 text-slate-400 border-b border-slate-50 pb-2">
                  ...
                  <h2 className="text-sm font-bold uppercase tracking-wider">التكلفة والمدة</h2>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-700 block">مدة التسليم</label>
                    <div className="relative">
      ...
      <div className="max-w-4xl mx-auto mt-8 flex items-start gap-3 p-4 bg-amber-50 border border-amber-100 rounded-2xl">
        ...
        <p className="text-xs text-amber-800 leading-relaxed text-start">
          <strong>نصيحة:</strong> تأكد من أن نطاق العمل واضح تماماً لتجنب النزاعات المستقبلية. بمجرد إرسال العرض وقبوله من العميل، يصبح العقد ملزماً للطرفين.
        </p>
      </div>
    </div>
  );
